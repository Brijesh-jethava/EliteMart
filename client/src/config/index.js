...
export const addressFormControls = [
  ...
  { label: "Phone", name: "phone", componentType: "input", type: "tel", placeholder: "Enter your phone number" },
  { label: "Notes", name: "notes", componentType: "textarea", type: "text", placeholder: "Additional notes (optional)" }
];
