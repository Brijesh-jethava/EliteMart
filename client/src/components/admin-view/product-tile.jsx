        ...
        <div>
            ...
            <CardContent>
                ...
                <div className='flex justify-between items-center mb-2'>
                    <span className={`${product?.salePrice > 0 ? 'line-through' : ""} text-xl font-semibold text-primary`}>${product?.price}</span>
                    {
            ...
            <CardFooter className='flex justify-between items-center'>
                ...
                <Button className='bg-black text-white' onClick={()=> handleDelete(product?._id)}>Delete</Button>
            </CardFooter>
        </div>
    </Card>
  )
